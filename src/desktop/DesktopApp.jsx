...
useEffect(() => {
  ...
  return (
    ...
    <div className="app">
      <CloudReveal />
      <div className="cloud-decor cloud-decor--top-left">
        <div className="cloud-decor__shape" />
      </div>
      <ParticlesBackground />
      <Navbar
        active={active}
          ...
          <div className="about__timeline-layout">
            <div className="about__intro">
              ...
              <p className="about__intro-desc">
                ...
                <strong>strong passion for web interface development and user experience design.</strong>
              </p>
              <p className="about__intro-desc">
                I have knowledge of{" "}
                <strong>JavaScript, ReactJS, TailwindCSS,</strong>{" "}
                along with an understanding of frontend development principles.
              </p>
              <p className="about__intro-desc">
            ...
            <div className="about__timeline">
              <div className="tl-item">
                ...
                <div className="tl-content">
                  ...
                  <p className="tl-sub">Information Technology · 09/2022 — 09/2026</p>
                  {/* <p className="tl-detail">Expected graduation: 08/2026</p> */}
                  <p className="tl-detail">GPA: 3.20 / 4.0</p>
                </div>
              </div>
            ...
            <div className="contact__info">
              ...
              <div className="info-card">
                <div>
                  ...
                  <p className="info-val">Ho Chi Minh City</p>
                </div>
              </div>
              {/* <div className="info-card">
                <div>
